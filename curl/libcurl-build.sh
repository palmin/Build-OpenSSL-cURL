...
catalyst="0"
FORCE_SSLV3="no"
CONF_FLAGS="--without-libidn2 --disable-ldap --disable-http --disable-file --disable-ldaps --disable-rtsp --disable-dict --disable-telnet --disable-tftp --disable-pop3 --disable-imap --disable-smb --disable-smtp --disable-gopher --disable-mqtt     --with-secure-transport --with-ca-fallback --disable-shared --enable-static -with-random=/dev/urandom"
